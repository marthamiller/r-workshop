...
mtcars_hp <- mtcars[order(mtcars$hp, decreasing = TRUE),]
...
draw(p1x, p1y)
new.p1y <- p1y
new.p1y[new.p1y > 75 & new.p1y < 100] <- 101
...
new.p2x[new.p2x > 50 & new.p2y > 50 ]<- new.p2x[new.p2x > 50 & new.p2y < 50  ]
new.p2y[new.p2y > 50 & new.p2x > 50 ]<- new.p2y[new.p2x > 50 & new.p2y < 50] + 10
...
new.p3x[p3x < 42 & p3y < 42 ] <- p3y[p3y < 42 & p3x < 42]
new.p3y[p3y < 42 & p3x < 42] <- p3x[p3x < 42 & p3y < 42]
